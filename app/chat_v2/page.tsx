					...
					{!historyLoaded ? (
						...
						<div className="flex flex-col items-center justify-center h-full gap-3 text-center px-8">
							...
							<p className="text-white/60 text-sm leading-relaxed">
								Type a message or tap the voice button to speak
								with your{" "}
				...
				<div className="border-t border-white/10 bg-[#1C2D3B]">
					{isResolved ? (
						...
						<ConversationBar
							...
							// ↓ KEY FIX: only starts the session once history (and
							// therefore overrides + dynamicVariables) are fully ready.
							// This eliminates the mount-race / StrictMode cancellation.
							...
							onHandover={async (reason) => {
								...
								try {
									...
									console.log(
										"AI Handover successful! Reason:",
										reason,
									);
								} catch (e) {
									console.error(
										"Failed to trigger takeover via client tool",
										e,
									);
								}
							}}
